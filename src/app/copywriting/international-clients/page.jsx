...
import { internationalClients } from "../../data/internationalClients";

export const metadata = {
  title: "International Clients | Copywriting | Aya Portfolio",
};
  ...
  return (
    <div className="w-full px-[12%] py-10 scroll-mt-20">
      <div className="flex items-center justify-between gap-4 mb-6">
        <h2 className="text-3xl sm:text-4xl font-Ovo">International Clients</h2>
        <Link
          href="/copywriting"
      ...
      <p className="text-gray-600 mb-8 text-lg leading-relaxed">
        Explore our international client portfolio spanning multiple countries and industries. Click on any business card to visit their Facebook page and see examples of cross-cultural content, global marketing campaigns, and international brand messaging.
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        {internationalClients.map((client) => (
          <a
            key={client.facebookUrl}
