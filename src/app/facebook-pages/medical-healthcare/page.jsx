...
export const metadata = {
  title: "Medical & Healthcare Facebook Pages | Content Creation | Aya Portfolio",
};

export default function MedicalHealthcareFacebookPagesPage() {
  const medicalHealthcarePages = facebookPagesData["Medical & Healthcare"];
  ...
  return (
    <div className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-gray-700 font-Ovo max-w-2xl">
        Explore medical and healthcare Facebook pages. Click a card to open the page in a new tab and discover content creation opportunities.
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        {medicalHealthcarePages.map((page, index) => (
          <a
            key={`medical-${index}`}
